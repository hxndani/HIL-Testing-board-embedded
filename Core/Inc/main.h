...
#define MPG_A_Pin GPIO_PIN_0
#define MPG_A_GPIO_Port GPIOB
#define MPG_B_Pin GPIO_PIN_1
#define MPG_B_GPIO_Port GPIOB
#define TES_OUT_Pin GPIO_PIN_8
#define TES_OUT_GPIO_Port GPIOC
#define TES_IN_Pin GPIO_PIN_9
#define TES_IN_GPIO_Port GPIOC
